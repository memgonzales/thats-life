...
/**
 * Class implementing a <b>ChooseCareerCard window</b> as part of the GUI for
 * choosing a career card
 */
public class ChooseCareerCard extends JFrame {
    /* Text area and button for the first career card */
    private JTextArea taOne;
    private JButton btnOne;

    /* Text area and button for the second career card */
    ...
    /**
     * Creates a ChooseCareerCard object
     *
     ...
     *
     * @param prompt prompt containing player instructions
     * @param nameCardOne name of the first career card
     * @param statsOne details of the first career card
     * @param nameCardTwo name of the second career card
     * @param statsTwo details of the second career card
     */
    public ChooseCareerCard (String prompt, String nameCardOne, String statsOne, String nameCardTwo, String statsTwo) {
    ...
    /**
     * Initializes the elements of the ChooseCareerCard object
     *
     * <p>The object contains a text prompt for the player and two text areas and buttons
     * for choosing a career card.</p>
     *
    ...
    private void init(String prompt, String statsOne, String statsTwo) {
        ...
        /* The details of the first career card are formatted and added to pLeft */
        ...
        /* The details of the second career card are formatted and added to pRight */
        ...
        /* Buttons for each of the career cards is added to pSouth */
