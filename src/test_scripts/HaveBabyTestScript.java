...
import spaces.magenta_spaces.HaveBaby;

import java.util.ArrayList;

/**
 * Test script for <code>Have Baby</code> class
 */
public class HaveBabyTestScript {
    public static void main(String[] args) {
        ...
        /* Constructor: HaveBaby ()
        One HaveBaby object is created. The indices for this test script are dummy
        values, as their values will not affect the tested methods in the script.
        */
        space1 = new HaveBaby(-1, -1);
        ...
        */
        ...
        Expected output: p1 receives 5000 from every other player.
        */
        ...
        the parameter.
        Expected output: The string "[Player name], you are on a Have Baby space.
        Receive [gift amount] from every other player as a gift."
        */
