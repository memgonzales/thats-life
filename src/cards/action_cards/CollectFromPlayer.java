 ...
 * the player to collect money from another player </b>
 *
 ...
 */
public abstract class CollectFromPlayer extends ActionCard implements MachineRandom {
    /* Amount of money to be collected from another player */
    private int amount;

    /* Lower bound for the possible amount of money to be collected from another player */
    private final int AMOUNT_LB;
    /* Upper bound for the possible amount of money to be collected from another player */
    private final int AMOUNT_UB;
    /* Increment for the possible amount of money to be collected from another player */
    private final int INCREMENT;

    /**
     * Constructor with the specified name, lower bound and upper bound, and increment
     * for the possible amount of money to be collected from another player as parameters
     *
     * <p>The name of an action card that asks the player to collect money from another player
     * is indicative of the action it specifies: File a Lawsuit, It's Your Birthday.</p>
     *
     * @param name name of this card
     * @param amountLB lower bound for the possible amount of money to be collected from
     *                 another player
     * @param amountUB upper bound for the possible amount of money to be collected from
     *                 another player
     * @param increment increment for the possible amount of money to be collected from
     *                  another player
     */
    public CollectFromPlayer(String name, int amountLB, int amountUB, int increment) {
        ...
        for the possible amount of money to be collected from another player.
         */
        AMOUNT_LB = amountLB;
        AMOUNT_UB = amountUB;
        INCREMENT = increment;

        /* Initialize the amount of money to be collected from another player to a randomly generated
    ...
    /**
     * Returns the amount of money to be collected from another player
     *
     * @return amount of money to be collected from another player
     */
    ...
    /**
     * Returns the lower bound for the possible amount of money to be collected
     * from another player
     *
     * @return lower bound for the possible amount of money to be collected
     * from another player
     */
    ...
    /**
     * Returns the upper bound for the possible amount of money to be collected
     * from another player
     *
     * @return upper bound for the possible amount of money to be collected
     * from another player
     */
    ...
    /**
     * Returns the increment for the possible amount of money to be collected
     * from another player
     *
     * @return increment for the possible amount of money to be collected
     * from another player
     */
     ...
     *
     * <p>A separate (private) function sets the amount collected from another player to the
     * returned randomly generated value. </p>
     *
     ...
     * description as an action card that asks a player to collect money from another player
     *
     * <p>In particular, the representation contains the following details:</p>
     *
     * <ul>
     *     <li>Type of card (Action card)</li>
     *     <li>Name of the card (for example, File a Lawsuit, It's Your Birthday)</li>
    ...
    public String toString() {
        return super.toString() + "Collected from Other Player: ";
    }
}
