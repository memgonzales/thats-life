...
## Task
<b>That's Life</b> is the major course output for an object-oriented programming class. The complete project specifications are given in the file <code>Project Specifications.pdf</code>, authored by Ms. Shirley B. Chu of the College of Computer Studies of De La Salle University. Below are screenshots of the gameplay: <br/>
...
- <code>Project Specifications.pdf</code> - Complete project specifications
